                            ...
                            <div class="heading-tabs">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                          <li><a href='#tabs-1'><img src="{{asset('images/tab-icon-01.png')}}" alt="">Breakfast</a></li>
                                          <li><a href='#tabs-2'><img src="{{asset('images/tab-icon-02.png')}}" alt="">Lunch</a></a></li>
                                          <li><a href='#tabs-3'><img src="{{asset('images/tab-icon-03.png')}}" alt="">Dinner</a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="left-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('images/tab-item-01.png')}}" alt="">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('images/tab-item-02.png')}}" alt="">
                                                            <h4>Orange Juice</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur koit adipiscing elit, sed do.</p>
                                                            <div class="price">
                                                                <h6>$8.50</h6>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('images/tab-item-03.png')}}" alt="">
                                                            <h4>Fruit Salad</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur koit adipiscing elit, sed do.</p>
                                                            <div class="price">
                                                                <h6>$9.90</h6>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('images/tab-item-04.png')}}" alt="">
                                                            <h4>Eggs Omelette</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur koit adipiscing elit, sed do.</p>
                                                            <div class="price">
                                                                <h6>$6.50</h6>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('images/tab-item-05.png')}}" alt="">
                                                            <h4>Dollma Pire</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur koit adipiscing elit, sed do.</p>
                                                            <div class="price">
                                                                <h6>$5.00</h6>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('images/tab-item-06.png')}}" alt="">
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="logo">
                        <a href="index.html"><img src="{{asset('images/white-logo.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
